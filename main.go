...
func FilterByCreation(data []MyArtistFull, from string, till string) []MyArtistFull {
	if from == "" || till == "" {
		return data
	}
...
func FilterByMember(data []MyArtistFull, mem []int) []MyArtistFull {
...
func FilterByAlbumDate(data []MyArtistFull, albumStart string, albumEnd string) []MyArtistFull {
	layOut := "2006-01-02"
...
func FilterByLocation(data []MyArtistFull, location string) []MyArtistFull {
	var tmp []MyArtistFull
